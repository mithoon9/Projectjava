        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (name.getText().toString().isEmpty() && address.getText().toString().isEmpty()
                    ...
                    Toast.makeText(Register.this, "All fields are required", Toast.LENGTH_LONG);
                } else {
                    Toast.makeText(Register.this, "All fields found, adding to database", Toast.LENGTH_LONG);
